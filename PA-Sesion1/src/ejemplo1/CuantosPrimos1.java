...
public class CuantosPrimos1 {
    public static void main(String[] x){
           ...
           p4.calcular();
           p5.calcular();
           long n = p1.cuantos() + p2.cuantos() + p3.cuantos() + p4.cuantos() + p5.cuantos();
           ...
           System.out.println("P1: " + p1.cuantos());
           System.out.println("P2: " + p2.cuantos());
           System.out.println("P3: " + p3.cuantos());
           System.out.println("P4: " + p4.cuantos());
           System.out.println("P5: " + p5.cuantos());
